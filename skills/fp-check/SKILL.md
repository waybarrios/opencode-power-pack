...
Follow [deep-verification.md](references/deep-verification.md). Break the work into a full task dependency graph and execute each phase methodically, delegating to subagents where the host supports it.
